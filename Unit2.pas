...
begin
  ...
  if Q_Cars.FieldByName('CarCondition').AsInteger = 0 then
    ...
    Form1.RichEditParams.Text := 'Б/У ' + Q_Cars.FieldByName('CarName').AsString + sLineBreak + sLineBreak;
  Form1.RichEditParams.Text := Form1.RichEditParams.Text + 'Год выпуска               ' + Q_Cars.FieldByName('CarBirth').AsString + sLineBreak;
  Form1.RichEditParams.Text := Form1.RichEditParams.Text + 'Цена, Р                       ' + Q_Cars.FieldByName('CarCost').AsString + sLineBreak;
  Form1.RichEditParams.Text := Form1.RichEditParams.Text + 'КПП                            ' + Q_Cars.FieldByName('GearType').AsString + sLineBreak;
  Form1.RichEditParams.Text := Form1.RichEditParams.Text + 'Кузов                          ' + Q_Cars.FieldByName('CarBodyName').AsString + sLineBreak;
  Form1.RichEditParams.Text := Form1.RichEditParams.Text + 'Двигатель                  ' + Q_Cars.FieldByName('EngineTypeName').AsString + sLineBreak;
  Form1.RichEditParams.Text := Form1.RichEditParams.Text + 'Объём двигателя, л    ' + Q_Cars.FieldByName('CarTechEngineVolume').AsString + sLineBreak;
  ...
  if Q_Cars.FieldByName('CarCondition').AsInteger = 0 then
    ...
    Form7.RichEditParams.Text := 'Б/У ' + Q_Cars.FieldByName('CarName').AsString + sLineBreak + sLineBreak;
  Form7.RichEditParams.Text := Form7.RichEditParams.Text + 'Год выпуска               ' + Q_Cars.FieldByName('CarBirth').AsString + sLineBreak;
  Form7.RichEditParams.Text := Form7.RichEditParams.Text + 'Цена, Р                       ' + Q_Cars.FieldByName('CarCost').AsString + sLineBreak;
  Form7.RichEditParams.Text := Form7.RichEditParams.Text + 'КПП                            ' + Q_Cars.FieldByName('GearType').AsString + sLineBreak;
  Form7.RichEditParams.Text := Form7.RichEditParams.Text + 'Кузов                          ' + Q_Cars.FieldByName('CarBodyName').AsString + sLineBreak;
  Form7.RichEditParams.Text := Form7.RichEditParams.Text + 'Двигатель                  ' + Q_Cars.FieldByName('EngineTypeName').AsString + sLineBreak;
  Form7.RichEditParams.Text := Form7.RichEditParams.Text + 'Объём двигателя, л    ' + Q_Cars.FieldByName('CarTechEngineVolume').AsString + sLineBreak;
  ...
  if Q_Cars.FieldByName('CarCondition').AsInteger = 0 then
    Form9.RichEditParams.Text := 'Новая ' + Q_Cars.FieldByName('CarName').AsString + sLineBreak + sLineBreak
  else
    Form9.RichEditParams.Text := 'Б/У ' + Q_Cars.FieldByName('CarName').AsString + sLineBreak + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Год выпуска               ' + Q_Cars.FieldByName('CarBirth').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Цена, Р                       ' + Q_Cars.FieldByName('CarCost').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'КПП                            ' + Q_Cars.FieldByName('GearType').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Кузов                          ' + Q_Cars.FieldByName('CarBodyName').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Двигатель                  ' + Q_Cars.FieldByName('EngineTypeName').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Объём двигателя, л    ' + Q_Cars.FieldByName('CarTechEngineVolume').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Привод                       ' + Q_Cars.FieldByName('DriveType').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Мощность, л.с.           ' + Q_Cars.FieldByName('CarTechPower').AsString + sLineBreak;
  Form9.RichEditParams.Text := Form9.RichEditParams.Text + 'Расположение руля    ' + Q_Cars.FieldByName('WheelType').AsString + sLineBreak;
  if Q_Cars.FieldByName('CarAddress').AsString.CompareTo('').ToBoolean then
