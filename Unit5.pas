...
procedure TForm5.CarAddClick(Sender: TObject);
begin
...
procedure TForm5.CarImageDeleteClick(Sender: TObject);
begin
  CarImagePath := '';
  CarImage.Picture.LoadFromFile('NI.png');
end;

procedure TForm5.CarSellClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm5.CarUpdateClick(Sender: TObject);
begin
  if CarBirth.Text > System.SysUtils.CurrentYear.ToString then begin
    MessageDlg('√од производства машины из будущего', mtCustom, [mbOk], 0);
    Exit;
...
procedure TForm5.SellerCheckFilterClick(Sender: TObject);
begin
...
procedure TForm5.ImageButtonClick(Sender: TObject);
begin
...
procedure TForm5.SellerAddClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm5.SellerButtonClick(Sender: TObject);
begin
...
procedure TForm5.SellerDeleteClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm5.SellerUpdateClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
