...
procedure TForm7.ButtonChatClick(Sender: TObject);
begin
  Form8.Show();
end;

procedure TForm7.ButtonClearClick(Sender: TObject);
begin
  Filter := False;
...
procedure TForm7.ButtonDeleteSellerClick(Sender: TObject);
begin
  SellerImagePath := 'D:\Images\NI.jpg';
  SellerImage.Picture.LoadFromFile('D:\Images\NI.jpg');
end;

procedure TForm7.ButtonFilterClick(Sender: TObject);
begin
  Filter := True;
...
procedure TForm7.ButtonLoadSellerClick(Sender: TObject);
begin
...
procedure TForm7.ButtonRefreshClick(Sender: TObject);
begin
  DataModule2.Q_Chat.Active := False;
  DataModule2.Q_Chat.Active := True;
end;

procedure TForm7.ButtonSellCarClick(Sender: TObject);
begin
  Form6.Show;
end;

procedure TForm7.ButtonSendClick(Sender: TObject);
begin
...
procedure TForm7.CarImageDeleteClick(Sender: TObject);
begin
  CarImagePath := 'D:\Images\NI.jpg';
  ImageCarSeller.Picture.LoadFromFile('D:\Images\NI.jpg');
end;

procedure TForm7.CarImageLoadClick(Sender: TObject);
begin
  if OpenPictureDialog.Execute then
    if FileExists(OpenPictureDialog.FileName) then begin
...
procedure TForm7.CarSellClick(Sender: TObject);
begin
...
procedure TForm7.CarUpdateClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm7.ComboBoxBrandChange(Sender: TObject);
begin
  ComboBoxModel.ItemIndex := -1;
...
procedure TForm7.ComboBoxBrandSelfChange(Sender: TObject);
begin
...
procedure TForm7.ComboBoxSortChange(Sender: TObject);
begin
  if Filter then
...
procedure TForm7.ImageBodyClick(Sender: TObject);
begin
  ComboBoxBody.ItemIndex := -1;
end;

procedure TForm7.ImageBrandClick(Sender: TObject);
begin
  ComboBoxBrand.ItemIndex := -1;
  ComboBoxModel.ItemIndex := -1;
  ComboBoxModel.Items.Clear;
...
procedure TForm7.ImageCostClick(Sender: TObject);
begin
  EditCost1.Text := '';
  EditCost2.Text := '';
end;

procedure TForm7.ImageDriveClick(Sender: TObject);
begin
  ComboBoxDrive.ItemIndex := -1;
end;

procedure TForm7.ImageEngineClick(Sender: TObject);
begin
  ComboBoxEngine.ItemIndex := -1;
end;

procedure TForm7.ImageGearClick(Sender: TObject);
begin
  ComboBoxGear.ItemIndex := -1;
end;

procedure TForm7.ImageModelClick(Sender: TObject);
begin
  ComboBoxModel.ItemIndex := -1;
end;

procedure TForm7.ImagePowerClick(Sender: TObject);
begin
  EditPower1.Text := '';
  EditPower2.Text := '';
end;

procedure TForm7.ImageVolumeClick(Sender: TObject);
begin
  EditVolume1.Text := '';
  EditVolume2.Text := '';
end;

procedure TForm7.ImageYearClick(Sender: TObject);
begin
  EditYear1.Text := '';
  EditYear2.Text := '';
end;
...
procedure TForm7.SellerDeleteClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm7.SellerUpdateClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
