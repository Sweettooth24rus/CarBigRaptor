...
procedure TForm9.ButtonChatClick(Sender: TObject);
begin
  Form8.Show();
end;

procedure TForm9.ButtonClearClick(Sender: TObject);
begin
  Filter := False;
...
procedure TForm9.ButtonDeleteSellerClick(Sender: TObject);
begin
  SellerImagePath := 'D:\Images\NI.jpg';
  SellerImage.Picture.LoadFromFile('D:\Images\NI.jpg');
end;

procedure TForm9.ButtonFilterClick(Sender: TObject);
begin
  Filter := True;
...
procedure TForm9.ButtonLoadSellerClick(Sender: TObject);
begin
...
procedure TForm9.ButtonRefreshClick(Sender: TObject);
begin
  DataModule2.Q_Chat.Active := False;
  DataModule2.Q_Chat.Active := True;
end;

procedure TForm9.ButtonSellCarClick(Sender: TObject);
begin
  Form6.Show;
end;

procedure TForm9.ButtonSendClick(Sender: TObject);
begin
...
procedure TForm9.CarImageDeleteClick(Sender: TObject);
begin
  CarImagePath := 'D:\Images\NI.jpg';
  ImageCarSeller.Picture.LoadFromFile('D:\Images\NI.jpg');
end;

procedure TForm9.CarImageLoadClick(Sender: TObject);
begin
  if OpenPictureDialog.Execute then
    if FileExists(OpenPictureDialog.FileName) then begin
...
procedure TForm9.CarSellClick(Sender: TObject);
begin
...
procedure TForm9.CarUpdateClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm9.ComboBoxBrandChange(Sender: TObject);
begin
  ComboBoxModel.ItemIndex := -1;
...
procedure TForm9.ComboBoxBrandSelfChange(Sender: TObject);
begin
...
procedure TForm9.ComboBoxSortChange(Sender: TObject);
begin
  if Filter then
...
begin
  ...
  ComboBoxSort.Items.Add('Даты размещения');
  ComboBoxSort.Items.Add('Цены');
  ComboBoxSort.Items.Add('Года производства');
  ComboBoxSort.Items.Add('Названия');
  ComboBoxSort.Items.Add('Объёма двигателя');
  ComboBoxSort.Items.Add('Мощности двигателя');
...
procedure TForm9.ImageBodyClick(Sender: TObject);
begin
  ComboBoxBody.ItemIndex := -1;
end;

procedure TForm9.ImageBrandClick(Sender: TObject);
begin
  ComboBoxBrand.ItemIndex := -1;
  ComboBoxModel.ItemIndex := -1;
  ComboBoxModel.Items.Clear;
...
procedure TForm9.ImageCostClick(Sender: TObject);
begin
  EditCost1.Text := '';
  EditCost2.Text := '';
end;

procedure TForm9.ImageDriveClick(Sender: TObject);
begin
  ComboBoxDrive.ItemIndex := -1;
end;

procedure TForm9.ImageEngineClick(Sender: TObject);
begin
  ComboBoxEngine.ItemIndex := -1;
end;

procedure TForm9.ImageGearClick(Sender: TObject);
begin
  ComboBoxGear.ItemIndex := -1;
end;

procedure TForm9.ImageModelClick(Sender: TObject);
begin
  ComboBoxModel.ItemIndex := -1;
end;

procedure TForm9.ImagePowerClick(Sender: TObject);
begin
  EditPower1.Text := '';
  EditPower2.Text := '';
end;

procedure TForm9.ImageVolumeClick(Sender: TObject);
begin
  EditVolume1.Text := '';
  EditVolume2.Text := '';
end;

procedure TForm9.ImageYearClick(Sender: TObject);
begin
  EditYear1.Text := '';
  EditYear2.Text := '';
end;
...
begin
  if Sort then
    Label4.Caption := 'Сортировка по убыванию'
  else
...
procedure TForm9.SellerDeleteClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
...
procedure TForm9.SellerUpdateClick(Sender: TObject);
begin
  with DataModule2.Q_Act do
  begin
    SQL.Clear;
